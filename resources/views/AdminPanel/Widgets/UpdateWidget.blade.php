...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        <li class="active">{{\Illuminate\Support\Str::limit($widget->name,40)}}</li>
    </ol>

    {!! Form::open(['files' => true,'method'=>'post','url'=>url('/AdminPanel/Widgets/'.$widget->id.'/Edit')]) !!}
    <!-- Input -->
    {!! csrf_field() !!}
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        {{\Illuminate\Support\Str::limit($widget->name,40)}}
                        ...
                        <div class="col-sm-4" id="widget_name">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('widget_name')) error @endif">
                                    {{ Form::text('widget_name',$widget->name,array('id'=>'widget_name','class'=>'form-control', 'placeholder'=>'')) }}
                                </div>
                        ...
                        <div class="col-sm-1">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('number')) error @endif">
                                    {{ Form::number('number',$widget->number,array('min'=>1,'id'=>'number','class'=>'form-control', 'placeholder'=>'')) }}
                                </div>
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('widget_type')) error @endif">
                                    ...
                                    {{ Form::select('widget_type',$select_widget_type,$widget->type,array('id'=>'widget_type','class'=>'form-control selectpicker show-tick','data-live-search'=>'true')) }}
                                </div>
                        ...
                        <div class="col-sm-3 articles">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('widget_category_id')) error @endif">
                                    ...
                                    {{ Form::select('widget_category_id',$select_category,$widget->category_id,array('id'=>'widget_category_id','class'=>'form-control selectpicker show-tick','data-live-search'=>'true')) }}
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('widget_query_type')) error @endif">
                                    ...
                                    {{ Form::select('widget_query_type',[
                                                                        ...
                                                                        ],$widget->query_type,array('id'=>'widget_query_type','class'=>'form-control selectpicker show-tick')) }}
                                </div>
                        ...
                        <div class="col-sm-2 articles">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('widget_count')) error @endif">
                                    {{ Form::number('widget_count',$widget->count,array('min'=>1,'id'=>'widget_count','class'=>'form-control', 'placeholder'=>'')) }}
                                </div>
                        ...
                        <div class="col-sm-9" id="ad">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('widget_ad_id')) error @endif">
                                    ...
                                    {{ Form::select('widget_ad_id',$select_ad,$widget->ad_id,array('id'=>'widget_ad_id','class'=>'form-control selectpicker show-tick','data-live-search'=>'true')) }}
                                </div>
                        ...
                        <div class="col-sm-5" id="questionnaire">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('widget_questionnaire_id')) error @endif">
                                    ...
                                    {{ Form::select('widget_questionnaire_id',$select_questionnaire,$widget->questionnaire_id,array('id'=>'widget_questionnaire_id','class'=>'form-control selectpicker show-tick','data-live-search'=>'true')) }}
                                </div>
                        ...
                        <div class="col-sm-5" id="feature_article">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('widget_article_id')) error @endif">
                                    ...
                                    {{ Form::select('widget_article_id',$select_article,$widget->article_id,array('id'=>'widget_article_id','class'=>'form-control selectpicker show-tick','data-live-search'=>'true')) }}
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('status')) error @endif">
                                    {{ Form::select('status',[
                                                                'active'=>'منشور',
                                                                'inactive'=>'مؤرشف',
                                                                ],$widget->status,array('id'=>'status','class'=>'form-control show-tick')) }}
                                </div>
