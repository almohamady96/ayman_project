...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        <li class="active"> تعديل بيانات مركز التدريب</li>
    </ol>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            تعديل بيانات مركز التدريب
                            <small>املأ البيانات بالأسفل لتعديل مركز التدريب</small>
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php
                                    $image_path = 'storage/app/Centers/' . $image->id . '/' . $image->file;
                                ?>
