...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        <li><a href="{{ URL::to('/AdminPanel/Certificates/') }}">إدارة المنظمين الإعلاميين </a></li>
        <li class="active"> تعديل بيانات إعتماد</li>
    </ol>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            تعديل بيانات إعتماد
                            <small>املأ البيانات بالأسفل لتعديل إعتماد</small>
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php
                                    $image_path = 'storage/app/Organizer1Types/' . $image->id . '/' . $image->file;
                                ?>
