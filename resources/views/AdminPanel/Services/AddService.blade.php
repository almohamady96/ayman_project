...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        <li><a href="{{ URL::to('/AdminPanel/Services') }}">إدارة الدورة التدريبية</a></li>
        <li class="active">إضافة دورة تدريبية جديدة</li>
    </ol>
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('SectionID')) error @endif">
                                        {{ Form::select('SectionID',$Sections,'',array('id'=>'SectionID','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('Ordered')) error @endif">
                                        {{ Form::number('Ordered','',array('id'=>'Ordered','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('Hours')) error @endif">
                                        {{ Form::number('Hours','',array('id'=>'Hours','class'=>'form-control')) }}
                                    </div>
                                    @if ($errors->has('Hours')) 
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('Days')) error @endif">
                                        {{ Form::number('Days','',array('id'=>'Days','class'=>'form-control')) }}
                                    </div>
                                    @if ($errors->has('Days')) 
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('des_ar')) error @endif">
                                        {{ Form::textarea('des_ar','',array('rows'=>'3','id'=>'des_ar','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('des_en')) error @endif">
                                        {{ Form::textarea('des_en','',array('rows'=>'3','id'=>'des_en','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('details_ar')) error @endif">
                                        {{ Form::textarea('details_ar','',array('id'=>'tinymce','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('details_en')) error @endif">
                                        {{ Form::textarea('details_en','',array('id'=>'tinymce','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('tab1_ar')) error @endif">
                                        {{ Form::textarea('tab1_ar','',array('id'=>'tinymce','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('tab1_en')) error @endif">
                                        {{ Form::textarea('tab1_en','',array('id'=>'tinymce','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('tab2_ar')) error @endif">
                                        {{ Form::textarea('tab2_ar','',array('id'=>'tinymce','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('tab2_en')) error @endif">
                                        {{ Form::textarea('tab2_en','',array('id'=>'tinymce','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('tab3_ar')) error @endif">
                                        {{ Form::textarea('tab3_ar','',array('id'=>'tinymce','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('tab3_en')) error @endif">
                                        {{ Form::textarea('tab3_en','',array('id'=>'tinymce','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('tab4_ar')) error @endif">
                                        {{ Form::textarea('tab4_ar','',array('id'=>'tinymce','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('tab4_en')) error @endif">
                                        {{ Form::textarea('tab4_en','',array('id'=>'tinymce','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('tab5_ar')) error @endif">
                                        {{ Form::textarea('tab5_ar','',array('id'=>'tinymce','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('tab5_en')) error @endif">
                                        {{ Form::textarea('tab5_en','',array('id'=>'tinymce','class'=>'form-control')) }}
                                    </div>
