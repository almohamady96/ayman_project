...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        <li><a href="{{ URL::to('/AdminPanel/Organizers/') }}">إدارة ألمنظمين الإداريين </a></li>
        <li class="active"> إضافه منظم إداري جديد</li>
    </ol>
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        إضافه منظم إداري جديد
                        <small>املأ البيانات بالأسفل لإضافه منظم إداري جديد</small>
