...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        <li><a href="{{ URL::to('/AdminPanel/Organizers/') }}">إدارة المنظمين الإداريين </a></li>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            تعديل البيانات
                            <small>املأ البيانات بالأسفل لتعديل المنظم الإداري</small>
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php
                                    $image_path = 'storage/app/partners/' . $image->id . '/' . $image->file;
                                ?>
