...
<head>
    ...
    <title>
        ...
        ?>
        {{$setting['title']->value != ''? $setting['title']->value.$title  : 'Cair Lift-Tech'.$title}}
    </title>
    <!-- Favicon
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ URL::to('/AdminPanel') }}">
            ...
            <!-- Notifications -->
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu scrollable-menu">
                        ...
                        <li class="body">
                            <ul class="menu">
                                ...
                                @foreach($notifications_unread as $notification)
                                    <li>
                                        <a href="{{url('/AdminPanel/ReadNotification/'.$notification->id)}}"
                                           class="">
                                            <div class="menu-info">
                        ...
                        <li class="footer">
                            <a href="{{url('/AdminPanel/AllNotifications/')}}" class="header text-muted">كل
                                الإشعارات</a>
                        </li>
                    </ul>
                </li>
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            <div class="image">
                <a href="{{url('/AdminPanel/UpdateProfile/')}}">
    ...
    <!-- #Menu -->
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2019 <a href="javascript:void(0);">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        file_picker_callback: function(cb, value, meta) {
            ...
            relative_urls: false,
            document_base_url: 'http://technomasrcloud.com/Demos/AutoMobile',
            language: "ar",
            directionality : "rtl",
            theme: "modern",
            height: 100,
