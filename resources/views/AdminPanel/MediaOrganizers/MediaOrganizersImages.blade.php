                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-left">
                                    <li><a href="{{ URL::to('/AdminPanel/MediaOrganizers/CreateMediaOrganizerImage') }}">منظم إعلامى جديد</a>
                                    </li>
                            ...
                            @foreach($images as $image)
                                <tr id="row_{{ $image->id }}">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{URL::to('storage/app/mediaorganizers/' . $image->id . '/' . $image->file)}}" target="_blank">
                                            <img src="{{URL::to('storage/app/mediaorganizers/' . $image->id . '/' . $image->file)}}"
                                    ...
                                    <td class="text-center">
                                            ...
                                            <a href="{{ URL::to('/AdminPanel/MediaOrganizers/'.$image->id.'/Edit') }}"
                                           class="btn bg-light-green waves-effect" data-toggle="tooltip"
                                           data-placement="top" title="تعديل" style="margin: auto">
                                            <i class="material-icons">settings</i>
                                        </a>
                                        <button onclick="showConfirmMessage('{{ URL::to('/AdminPanel/MediaOrganizers/'.$image->id.'/Delete') }}')"
