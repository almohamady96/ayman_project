...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        <li><a href="{{ URL::to('/AdminPanel/BookStands') }}">إدراه نماذج الحجز للحضور</a></li>
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <h2 class="card-inside-title">اللقب</h2>
                            <div class="form-group">
                                <div class="form-line @if($errors->has('')) error @endif">
                                    <p>{{$form->Title}}</p>
                                </div>
                        ...
                        <div class="col-sm-4">
                            <h2 class="card-inside-title">النشاط</h2>
                            <div class="form-group">
                                <div class="form-line @if($errors->has('')) error @endif">
                                <p>{{$form->Activity}}</p>
                                </div>
                        ...
                        <div class="col-sm-4">
                            <h2 class="card-inside-title">الدولة</h2>
                            <div class="form-group">
                                <div class="form-line @if($errors->has('')) error @endif">
                                <p>{{$form->Country}}</p>
                                </div>
                        ...
                        <div class="col-sm-3">
                            <h2 class="card-inside-title">الموقع الإلكترونى</h2>
                            <div class="form-group">
                                <div class="form-line @if($errors->has('')) error @endif">
                                <p>{{$form->WebSite}}</p>
                                </div>
                        ...
                        <div class="col-sm-3">
                            <h2 class="card-inside-title">SQM SPACE REQUIRED</h2>
                            <div class="form-group">
                                <div class="form-line @if($errors->has('')) error @endif">
                                  <p>{{$form->SQM}}</p>
                                </div>
