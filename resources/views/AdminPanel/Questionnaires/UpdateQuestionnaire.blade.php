...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        <li class="active">تعديل إستفتاء {{$questionnaire->q}}</li>
    </ol>
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        تعديل إستفتاء {{$questionnaire->q}}
                        <small> {{--@lang('site.Site_Name')--}}املأ البيانات بالأسفل تعديل إستفتاء {{$questionnaire->q}}</small>
                    </h2>
                </div>
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('questionnaire_q')) error @endif">
                                    {{ Form::text('questionnaire_q',$questionnaire->q,array('required','id'=>'questionnaire_q','class'=>'form-control', 'placeholder'=>'')) }}
                                </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('questionnaire_publishDate')) error @endif">
                                    {{ Form::text('questionnaire_publishDate',$questionnaire->publishDate,array('required','id'=>'questionnaire_publishDate','class'=>'datepicker form-control', 'placeholder'=>'')) }}
                                </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('questionnaire_expireDate')) error @endif">
                                    {{ Form::text('questionnaire_expireDate',$questionnaire->expireDate,array('required','id'=>'questionnaire_expireDate','class'=>'datepicker form-control', 'placeholder'=>'')) }}
                                </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('questionnaire_a1')) error @endif">
                                    {{ Form::text('questionnaire_a1',$questionnaire->a1,array('id'=>'','class'=>'form-control', 'placeholder'=>'')) }}
                                </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('questionnaire_a2')) error @endif">
                                    {{ Form::text('questionnaire_a2',$questionnaire->a2,array('id'=>'','class'=>'form-control', 'placeholder'=>'')) }}
                                </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('questionnaire_a3')) error @endif">
                                    {{ Form::text('questionnaire_a3',$questionnaire->a3,array('id'=>'','class'=>'form-control', 'placeholder'=>'')) }}
                                </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('questionnaire_a4')) error @endif">
                                    {{ Form::text('questionnaire_a4',$questionnaire->a4,array('id'=>'','class'=>'form-control', 'placeholder'=>'')) }}
                                </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('questionnaire_a5')) error @endif">
                                    {{ Form::text('questionnaire_a5',$questionnaire->a5,array('id'=>'','class'=>'form-control', 'placeholder'=>'')) }}
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('status')) error @endif">
                                    {{ Form::select('status',[
                                                                'active'=>'منشور',
                                                                'inactive'=>'مؤرشف',
                                                                ],$questionnaire->status,array('id'=>'status','class'=>'form-control show-tick')) }}
                                </div>
