                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-left">
                                    <li><a href="{{ URL::to('/AdminPanel/Gallery/CreateGalleryImage') }}">صوره جديد</a>
                                    </li>
                            ...
                            @foreach($images as $image)
                                <tr id="row_{{ $image->id }}">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{URL::to('storage/app/gallery/' . $image->id . '/' . $image->file)}}" target="_blank">
                                    ...
                                    <td class="text-center">
                                            ...
                                            <a href="{{ URL::to('/AdminPanel/Gallery/'.$image->id.'/Edit') }}"
                                           class="btn bg-light-green waves-effect" data-toggle="tooltip"
                                           data-placement="top" title="تعديل" style="margin: auto">
                                            <i class="material-icons">settings</i>
                                        </a>
                                        <button onclick="showConfirmMessage('{{ URL::to('/AdminPanel/Gallery/'.$image->id.'/Delete') }}')"
