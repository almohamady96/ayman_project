        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                         صوره {{$image->name}}
                        <small>املأ البيانات بالأسفل لتعديل الصوره</small>
                ...
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('number')) error @endif">
                                    {{ Form::number('number',$image->number,array('min'=>1,'id'=>'number','class'=>'form-control', 'placeholder'=>'')) }}
                                </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php
                                $image_path = 'storage/app/gallery/' . $image->id . '/' . $image->file;
                            ?>
