...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        <li class="active">تعديل بيانات : {{$user->name}}</li>
    </ol>
            ...
            <div class="card">
                <div class="header">
                    <h2>
                        ...
                        <small>املأ البيانات بالأسفل لتعديل البيانات </small>
                    </h2>
                </div>
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-3">
                            <h2 class="card-inside-title"> حاله العضويه</h2>
                            <div class="form-group">
                                <div class="form-line @if($errors->has('isActive')) error @endif">

                                    {{ Form::select('isActive' ,[
                                                                    '1'=>'نشط',
                                                                    '0'=>'غير نشط',
                                                                    ],$user->isActive,array('id'=>'isActive','class'=>'form-control show-tick'
                                                                                        )) }}
                                </div>
                                @if ($errors->has('isActive'))
                                    <label id="isActive-error" class="error"
                                           for="isActive">{{ $errors->first('isActive') }}</label>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3" id="select_categories">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('categories')) error @endif">
                                    ...
                                    {{ Form::select('categories[]' ,$select_category,unserialize(base64_decode($user->categories)),array('id'=>'categories','class'=>'form-control show-tick','data-live-search'=>true,'multiple'=>true)) }}
                                </div>
