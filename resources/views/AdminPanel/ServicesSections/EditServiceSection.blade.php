...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        <li class="active">تعديل بيانات القسم</li>
    </ol>
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('Title_ar')) error @endif">
                                        {{ Form::text('Title_ar',$Section->Title_ar,array('id'=>'Title_ar','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('Title_en')) error @endif">
                                        {{ Form::text('Title_en',$Section->Title_en,array('id'=>'Title_en','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('Ordered')) error @endif">
                                        {{ Form::text('Ordered',$Section->Ordered,array('id'=>'Ordered','class'=>'form-control')) }}
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-group center">
                                        <div id="Logo-holder" class="col-sm-12">
                                            @if($Section->photo != '')
                                                <img src="{{ asset('storage/app/public/ServicesSections/'.$Section->id.'/'.$Section->photo) }}">
                                            @endif
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="btn">
