                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-left">
                                    <li><a href="{{ URL::to('/AdminPanel/TeamMembers/CreateTeamMemberImage') }}">عضو جديد</a>
                                    </li>
                            ...
                            @foreach($images as $image)
                                <tr id="row_{{ $image->id }}">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{URL::to('storage/app/TeamMembers/' . $image->id . '/' . $image->file)}}" target="_blank">
                                            <img src="{{URL::to('storage/app/TeamMembers/' . $image->id . '/' . $image->file)}}"
                                            style="max-width: 400px;max-height: 100px">
                                        </a>

                                    </td>
                                    <td class="text-TeamMember">

                                            <a href="{{ URL::to('/AdminPanel/TeamMembers/'.$image->id.'/Edit') }}"
                                           class="btn bg-light-green waves-effect" data-toggle="tooltip"
                                           data-placement="top" title="تعديل" style="margin: auto">
                                            <i class="material-icons">settings</i>
                                        </a>
                                        <button onclick="showConfirmMessage('{{ URL::to('/AdminPanel/TeamMembers/'.$image->id.'/Delete') }}')"
