...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        <li class="active"> إضافه عضو جديد</li>
    </ol>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        إضافه عضو جديد
                        <small>املأ البيانات بالأسفل لإضافه عضو جديد</small>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="form-line @if($errors->has('image_des')) error @endif">
                                    {{ Form::text('image_des','',array('required'=>true,'id'=>'image_des','class'=>'form-control', 'placeholder'=>'')) }}
                                </div>
