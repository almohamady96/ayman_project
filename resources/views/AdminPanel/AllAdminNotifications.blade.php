                        ...
                        <table class="table table-bordered  table-hover js-basic-example dataTable">
                            ...
                            @foreach($notifications as $notification)
                                ...
                                <tr id="row_{{ $notification->id }}" class="{{$txt_color}}">
                                    ...
                                    <td>
                                        <a href="{{url('/AdminPanel/ReadNotification/'.$notification->id)}}" style="text-decoration: none;color: inherit">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button onclick="showConfirmMessage('{{ URL::to('/AdminPanel/delete_notification/'.$notification->id) }}')"
