                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('VideoTitle_ar')) error @endif">
                                        {{ Form::text('VideoTitle_ar','',array('id'=>'VideoTitle_ar','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('VideoTitle_en')) error @endif">
                                        {{ Form::text('VideoTitle_en','',array('id'=>'VideoTitle_en','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('VideoCode')) error @endif">
                                        {{ Form::text('VideoCode','',array('id'=>'VideoCode','class'=>'form-control')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('VideoDes_ar')) error @endif">
                                        {{ Form::textarea('VideoDes_ar','',array('id'=>'VideoDes_ar','class'=>'form-control','rows'=>'3')) }}
                                    </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line @if($errors->has('VideoDes_en')) error @endif">
                                        {{ Form::textarea('VideoDes_en','',array('id'=>'VideoDes_en','class'=>'form-control','rows'=>'3')) }}
                                    </div>
