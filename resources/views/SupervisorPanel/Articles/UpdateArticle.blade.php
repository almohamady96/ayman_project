...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        @if(isset($category))
            <li><a href="{{ URL::to('/SupervisorPanel/Categories') }}">إداره الأقسام</a></li>
            <li>
                <a href="{{ URL::to('/SupervisorPanel/Categories/'.$category->id.'/Articles') }}">مقالات {{\Illuminate\Support\Str::limit($category->name,40)}}</a>
            </li>
        @else
            <li><a href="{{ URL::to('/SupervisorPanel/Articles') }}">كل المقالات</a></li>
        @endif
        <li class="active">{{\Illuminate\Support\Str::limit($article->name,40)}}</li>
    </ol>

    {!! Form::open(['files' => true,'method'=>'post','url'=>url('/SupervisorPanel/Articles/'.$article->id.'/Edit')]) !!}
    <!-- Input -->
    {!! csrf_field() !!}
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line @if($errors->has('article_name')) error @endif">
                                            {{ Form::text('article_name',$article->name,array('required'=>true,'id'=>'article_name','class'=>'form-control', 'placeholder'=>'')) }}
                                        </div>
                                        @if ($errors->has('article_name'))
                                            <label id="article_name-error" class="error"
                                                   for="article_name">{{ $errors->first('article_name') }}</label>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line @if($errors->has('article_description')) error @endif">
                                            {{ Form::textarea('article_description',$article->description,array('id'=>'tinymce','class'=>'form-control', 'placeholder'=>'')) }}
                                        </div>
                                        @if ($errors->has('article_description'))
                                            <label id="article_description-error" class="error"
                                                   for="article_description">{{ $errors->first('article_description') }}</label>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-7" id="slider_files">
                                    ...
                                    <div class="row" id="row" style="">
                                        ...
                                        <div class="col-sm-4 text-center" id="row_{{ $x }}">
                                            ...
                                            <div class="clearfix"></div>
                                            <span onclick="showConfirmMessage('{{ URL::to('/SupervisorPanel/Articles/'.$article->id.'/'.$photo.'/'.$x.'/DeletePhoto') }}')"
                                ...
                                <div class="col-sm-5">
                                    ...
                                    @if($article->seo_image != null)
                                        ...
                                        <div class="col-sm-12" id="row_{{ $x }}">
                                            ...
                                            <div class="clearfix"></div>
                                            <span onclick="showConfirmMessage('{{ URL::to('/SupervisorPanel/SeoImage/'.$article->id.'/'.$article->seo_image.'/'.$x.'/Article/Delete') }}')"
                                                  class="btn btn-danger btn-sm btn-block"
