...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        @if(isset($category))
            ...
            <li>
                <a href="{{ URL::to('/SupervisorPanel/Categories/'.$category->id.'/Articles') }}">مقالات {{$category->name}}</a>
            </li>
        @else
    ...
    {!! Form::open(['files' => true,'method'=>'post','url'=>url('/SupervisorPanel/Articles/CreateArticle')]) !!}
    <!-- Input -->
    {!! csrf_field() !!}
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line @if($errors->has('article_name')) error @endif">
                                            {{ Form::text('article_name','',array('required'=>true,'id'=>'article_name','class'=>'form-control', 'placeholder'=>'')) }}
                                        </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line @if($errors->has('article_description')) error @endif">
                                            {{ Form::textarea('article_description','',array('id'=>'tinymce','class'=>'form-control', 'placeholder'=>'')) }}
                                        </div>
