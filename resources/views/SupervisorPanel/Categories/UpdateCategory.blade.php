...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-bg-teal">
        ...
        <li class="active"> تعديل قسم {{$category->name}}</li>
    </ol>
            ...
            <div class="card">
                <div class="header">
                    <h2>
                        ...
                        <small>املأ البيانات بالأسفل لتعديل قسم {{$category->name}}</small>
                ...
                <div class="body">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="data">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-3">
                                    <h2 class="card-inside-title">إسم القسم </h2>
                                    <div class="form-group">
                                        <div class="form-line @if($errors->has('category_name')) error @endif">
                                            {{ Form::text('category_name',$category->name,array('required'=>true,'id'=>'category_name','class'=>'form-control', 'placeholder'=>'')) }}
                                        </div>
                                        @if ($errors->has('category_name'))
                                            <label id="category_name-error" class="error"
                                ...
                                {{--<div class="col-sm-3">
                                    ...
                                    @if($category->image != null)
                                        <div class="col-sm-12" id="row_{{ $x }}">
                                            ...
                                            <div class="clearfix"></div>
                                            <span onclick="showConfirmMessage('{{ URL::to('/SupervisorPanel/Categories/'.$category->id.'/'.$category->image.'/'.$x.'/DeleteImage') }}')"
                                ...
                                <div class="col-sm-5">
                                    ...
                                    @if($category->seo_image != null)
                                        ...
                                        <div class="col-sm-12" id="row_{{ $x }}">
                                            ...
                                            <div class="clearfix"></div>
                                            <span onclick="showConfirmMessage('{{ URL::to('/SupervisorPanel/SeoImage/'.$category->id.'/'.$category->seo_image.'/'.$x.'/Category/Delete') }}')"
                                                  class="btn btn-danger btn-sm btn-block"
