                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-left">
                                    <li><a href="{{ URL::to('/SupervisorPanel/Categories/CreateCategory') }}">إضافه قسم
                                            جديد</a>
                                    </li>
                            ...
                            @foreach($categories as $category)
                                ...
                                <tr id="row_{{ $category->id }}">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ URL::to('/SupervisorPanel/Categories/'.$category->id.'/Articles') }}"
                                           class="btn bg-light-blue waves-effect" data-toggle="tooltip"
                                           data-placement="top" title=" مقالات {{$category->name}}">
                                            <i class="material-icons">list</i>
                                        </a>

                                        <a href="{{ URL::to('/SupervisorPanel/Categories/'.$category->id.'/Edit') }}"
